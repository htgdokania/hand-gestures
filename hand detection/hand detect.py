...
eye_cascade = cv2.CascadeClassifier('fist.xml')

img = cv2.imread('hand4.jpg')#load image
cv2.namedWindow('img',cv2.WINDOW_NORMAL)#resize 
cv2.resizeWindow('img', 480,360)        #image
...
for (x,y,w,h) in faces:
    ...
    cv2.putText(img,'PALM {}'.format(c),(x,int(y+h/8)),font,w/170,(255,255,255),int(w/50))
